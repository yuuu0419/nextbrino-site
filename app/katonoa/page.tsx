...
export const metadata: Metadata = {
  title: "加藤 乃愛様　限定のご案内｜NEXT BRINO",
  description: "NEXT BRINOより、加藤 乃愛様　限定のご案内です。",
  robots: {
    index: false,
    follow: false,
  },
  openGraph: {
    title: "加藤 乃愛様　限定のご案内｜NEXT BRINO",
    description: "NEXT BRINOより、加藤 乃愛様　限定のご案内です。",
    url: "https://nextbrino.com/katonoa",
    siteName: "NEXT BRINO",
    images: [{ url: "https://nextbrino.com/images/katonoa-ogp.jpg", width: 1200, height: 630, alt: "加藤 乃愛様　限定のご案内｜NEXT BRINO" }],
    locale: "ja_JP",
    type: "website",
  },
  twitter: {
    ...
    title: "加藤 乃愛様　限定のご案内｜NEXT BRINO",
    description: "NEXT BRINOより、加藤 乃愛様　限定のご案内です。",
    images: ["https://nextbrino.com/images/katonoa-ogp.jpg"],
  },
};

export default function KatonoaPage() {
  return (
    <main className="min-h-screen bg-[#0a0f1e] text-white flex flex-col items-center py-16 px-4">
      <div className="w-full max-w-5xl">
        ...
        <div className="hidden md:block w-full border border-white/10 rounded overflow-hidden bg-white/5 mb-6">
          <iframe
            src="/katonoa.pdf#toolbar=0&navpanes=0&view=FitH"
            className="w-full"
        ...
        <div className="md:hidden w-full border border-white/10 rounded overflow-hidden bg-white mb-6">
          <PdfViewerWrapper file="/katonoa.pdf" />
        </div>
