...
const services = [
  ...
  { num:"05", en:"EDUCATION",          ja:"教育学習支援事業",      img:"/images/health-promotion-card.webp",     desc:"主に小中学生を対象に、独自のPREP法を活用した、\n完全双方向のアクティブラーニングを目指します。",                                  items:["PREP法（独自開発）による指導","完全双方向型の学習","アクティブラーニングの確立"] },
  { num:"06", en:"HEALTH PROMOTION",   ja:"健康増進事業",          img:"/images/education-card.webp",            desc:"科学的根拠に基づいた、健康寿命の延伸を目的とした指導や、\nアスリートを対象とした指導など幅広いサポートを提供しています。", descSp:"健康寿命の延伸を目的とした指導や、\nアスリートを対象としたコーチングなど\n幅広いサポートを提供しています。",  items:["体組成トレーニング","アスリートコーチング","栄養に関する指導","科学的根拠に基づいたトータル指導"] },
];
